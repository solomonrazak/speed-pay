...
// import CountCash from '../CountCash';
...
//             <div className="flex items-end"><p className="font-light">INVOICE 0941</p></div>
...
//             <button className="bg-slate-900 w-[170px] text-white rounded py-1 text-[13px] font-medium"><Link to="cash">Cash</Link></button>
//             <button className="bg-slate-900 w-[170px] text-white rounded py-1 text-[13px] font-medium">Mobile Money</button>
//             <button className="bg-slate-900 w-[170px] text-white rounded py-1 text-[13px] font-medium">UMB Cheque</button>
//             <button className="bg-slate-900 w-[170px] text-white rounded py-1 text-[13px] font-medium">Other Banck Cheque</button>
